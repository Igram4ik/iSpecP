...
public class BlockCommand {
    ...
    private void dropNetherite(PlayerEntity player) {
        if (player.getEquippedStack(EquipmentSlot.CHEST).getItem() == Registries.ITEM.get(Identifier.tryParse("minecraft:netherite_chestplate"))) {
        ...
        if (player.getEquippedStack(EquipmentSlot.HEAD).getItem() == Registries.ITEM.get(Identifier.tryParse("minecraft:netherite_helmet"))) {
        ...
        if (player.getEquippedStack(EquipmentSlot.FEET).getItem() == Registries.ITEM.get(Identifier.tryParse("minecraft:netherite_boots"))) {
        ...
        if (player.getEquippedStack(EquipmentSlot.LEGS).getItem() == Registries.ITEM.get(Identifier.tryParse("minecraft:netherite_leggings"))) {
